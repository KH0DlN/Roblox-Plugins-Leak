## Intro
This repo currently contains `10 paid plugins` that you can download for free.
This repo is constantly getting updated with new and improved plugins.
Last update `06/17/25`.
...
## Request a plugin
If you want to request a plugin, simply make a issue with the title: 
Suggestion ( Plugin Name ) and in the description add the link to that plugin
